...
class EditAnimals extends Component {
  ...
  onSubmit = e => {
    ...
    if (files) {
      ...
      cowsRef
        .child(`${filesPath}/${files[0].name}add`)
        .put(files[0])
        .then(snapshot => {
          ...
          cowsRef
            ...
            .then(url => {
              ...
              this.props.firestore
                .update(
                  { collection: "cows", doc: this.props.cow.id },
                  editedAnimal
                )
                .then(() => {
      ...
      this.props.firestore
        .update({ collection: "cows", doc: this.props.cow.id }, editedAnimal)
        .then(() => {
          this.props.history.push("/");
          window.location.reload(); //@TODO: melhorara a gambiarra
        });
